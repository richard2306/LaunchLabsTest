		...
		<div class="et-pb-main-settings">
			...
			<div class="et-pb-option">
				...
				<div class="et-pb-option-container">
					...
					<p class="description">All videos should be uploaded in both .MP4 .WEBM formats to ensure maximum compatibility in all browsers. Upload the .MP4 version here.</p>
				</div> <!-- .et-pb-option-container -->
			</div> <!-- .et-pb-option -->
			...
			<div class="et-pb-option">
				...
				<div class="et-pb-option-container">
					...
					<p class="description">All videos should be uploaded in both .MP4 .WEBM formats to ensure maximum compatibility in all browsers. Upload the .WEBM version here.</p>
				</div> <!-- .et-pb-option-container -->
			</div> <!-- .et-pb-option -->
